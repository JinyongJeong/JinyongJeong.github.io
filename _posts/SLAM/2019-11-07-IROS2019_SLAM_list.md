---
layout: post
title: '[SLAM] IROS2019 SLAM 관련 논문 정리'
tags: [SLAM]
description: >
...
- 결론적으로 여러대에서 들어오는 데이터를 이용해서 road marking의 layout을 뽑는 논문인데, 여러 객체에서 들어오는 데이터의 alignment 부분은 되어 있다고 보고, clustering/filtering을 통해 road marking layout을 뽑는 것에 집중되어 있어서 실제로 crowdsource data를 썻다고 하기 애매해 보인다
