---
layout: post
title: 'Github permission error (403 error)'
tags: [software]
description: >
  Github permission error (403 error)
---

[참고](https://recoveryman.tistory.com/392)
...
<img align="middle" src="images/post/software/github_403error/에러.png" width="100%">

### 간단 해결방법

제어판에 사용자 계정으로 들어간다.

<img align="middle" src="images/post/software/github_403error/자격증명.png" width="100%">

사용자 계정으로 들어가면 각 계정에 해당되는 자격증명 관리로 들어간다. 위 그림의 표시를 누르면 자격증명 관리로 넘어간다. 


<img align="middle" src="images/post/software/github_403error/삭제.png" width="100%">
